...
function adicionarTarefa(texto) {
  ...
  // b. Definir o conteúdo textual do novo item
  novoItem.textContent = texto;

  // c. Anexar o novo item à lista de tarefas (<ul>)
  listaDeTarefas.append(novoItem);

  // d. Limpar o campo de entrada para a próxima inserção
  inputTarefa.value = "";

  // e. Devolver o foco ao campo de entrada
  inputTarefa.focus();
}
